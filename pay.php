        ...
        <h3 class="donor_p"><i class="fa fa-angle-right"></i>Payment Gateway</h3>
		  ...
		  <div class="block1">
				...
				<div class="card-body">
        			...
        			<input style="font-size:17px;" type="submit" class="btn btn-primary" name="submit" value="Submit Payment">
...
if(isset($_POST['submit']))
{
    ...
    // Item info
    $itemName = $_SESSION['bloodgrp'];
    $itemPrice = $_SESSION['bloodprice'];
    $currency = 'USD';
    $orderID = 'SKA92712382139';

    $query = "INSERT INTO `orders` (`name`, `email`, `card_num`, `card_exp_month`, `card_exp_year`, `card_cvv`, `item_name`, `item_price`, `currency`, `order_number`) VALUES ('$name', '$email', '$card_num', '$card_exp_month', '$card_exp_year', '$card_cvv', '$itemName', '$itemPrice', '$currency', '$orderID')";
		...
		else
		{
			?>
				<script>
					alert("Connection is not well Established:");
				</script>
			<?php
		}
